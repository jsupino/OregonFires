...
df['Control_DateTime'] = pd.to_datetime(df['Control_DateTime'])


# In[5]:


df1 = df.sort_values(by='FireYear')
df1
...
df2 = df.sort_values(by='Ign_DateTime')
df2
...
df3 = df.sort_values(by='ReportDateTime')
df3
...
df4 = df.sort_values(by='Discover_DateTime')
df4
...
df5 = df.sort_values(by='Control_DateTime')
df5
...
df2 = df.sort_values(by='ReportDateTime')
df2
